...
class PairEmbed(nn.Module):
    def __init__(self, pairwise_lv_dim, pairwise_input_dim, dims,
                 ...
                 normalize_input=True, activation='gelu', eps=1e-8, for_onnx=False):
        super().__init__()
...
class Block(nn.Module):
    def __init__(self, embed_dim=128, num_heads=8, ffn_ratio=4,
        ...
        self.attn = nn.MultiheadAttention(embed_dim, num_heads, dropout=attn_dropout, add_bias_kv=add_bias_kv)
...
class ParticleTransformer(nn.Module):
    def __init__(self, input_dim, num_classes=None,
                 ...
                 fc_params=[], activation='gelu',
                 trim=True, for_inference=False, use_amp=False, **kwargs) -> None:
        super().__init__(**kwargs)
